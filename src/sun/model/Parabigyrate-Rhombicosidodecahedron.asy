...
face fat = constructFace(AT, DC, confj1);
...
face fbl = constructFace(BL, DT, confj1);
face fbm = constructFace(BM, DT, conf);
face fbn = constructFace(BN, DD, confj2);
face fbo = constructFace(BO, DC, conf);
face fbp = constructFace(BP, DD, confj1);
face fbq = constructFace(BQ, DC, confj2);
...
face fcc = constructFace(CC, DT, confj2);
...
face fck = constructFace(CK, DL, confj2);
face fcl = constructFace(CL, DL, conf);
face fcm = constructFace(CM, DL, confj1);
face fcn = constructFace(CN, DP, confj1);
face fco = constructFace(CO, DK, conf);
face fcp = constructFace(CP, DK, conf);
face fcq = constructFace(CQ, DK, conf);
face fcr = constructFace(CR, DP, confj2);
...
vertex4 vorangegrey = constructVertex4(fbk, fbp, fbq, fbo);
vertex4 vlightbluegrey = constructVertex4(fbk, fbm, fbl, fbn);
...
vertex4 vlightgreengrey = constructVertex4(fat, fcr, fbs, fbo);
vertex4 vlightbluelime = constructVertex4(fca, fcc, fcm, fcb);
vertex4 vgreylime = constructVertex4(fbm, fcl, fcm, fcc);
...
vertex4 vgreypink = constructVertex4(fbs, fcn, fck, fcl);
...
drawFace(fbq, LightGreen + Ametist, t);
drawFace(far, LightGreen + Garnet, t, 8);
...
drawVertex5(vlightgreen, Tan, t, 3);
...
drawVertex4(vlightgreenorange, Green + Red, t, 1);
...
drawVertex4(vorangegrey, Red + White, t, 2);
