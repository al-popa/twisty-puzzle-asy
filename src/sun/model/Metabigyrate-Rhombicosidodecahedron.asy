...
drawFace(faj, Red + Brown, t, 4);
drawFace(fcq, Red + Ametist, t);
drawFace(fah, Red + Garnet, t, 11);
...
drawFace(fcm, Lime + Lilac);
drawFace(fck, Lime + Brown);
drawFace(fco, Lime + Ametist, t, 4);
