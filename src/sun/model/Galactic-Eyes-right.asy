...
bool[] conf = new bool[] {true, false, true, false, true, true, false, true, false, true, false};

triple AZ = unit(X / p + Y / q + Z);
...
glueFaces(faceY1, faceZ1, faceZ2, d);
glueFaces(faceY1, faceY2, faceZ2, d);
glueFaces(faceXX1, faceZ2, faceZ3, d);
glueFaces(faceXX1, faceXX2, faceZ3, d);
glueFaces(faceYY1, faceZ3, faceZ4, d);
glueFaces(faceYY1, faceYY2, faceZ4, d);
glueFaces(faceX2, faceZ4, faceZ1, d);
glueFaces(faceX1, faceX2, faceZ1, d);
glueFaces(faceYY3, faceZZ1, faceZZ2, d);
glueFaces(faceYY3, faceYY4, faceZZ2, d);
glueFaces(faceXX3, faceZZ2, faceZZ3, d);
glueFaces(faceXX3, faceXX4, faceZZ3, d);
glueFaces(faceY3, faceZZ3, faceZZ4, d);
glueFaces(faceY3, faceY4, faceZZ4, d);
glueFaces(faceX4, faceZZ4, faceZZ1, d);
glueFaces(faceX3, faceX4, faceZZ1, d);
glueFaces(faceX1, faceX4, faceY4, d);
glueFaces(faceX1, faceY1, faceY4, d);
glueFaces(faceY2, faceY3, faceXX4, d);
glueFaces(faceY2, faceXX1, faceXX4, d);
glueFaces(faceXX2, faceXX3, faceYY4, d);
glueFaces(faceXX2, faceYY1, faceYY4, d);
glueFaces(faceYY2, faceYY3, faceX3, d);
glueFaces(faceYY2, faceX2, faceX3, d);

drawFace(faceZ1, RGB(121, 45, 75)); // Bordo
drawFace(faceX1, RGB(164, 174, 173)); // Grey
drawFace(faceY1, RGB(255, 228, 1)); // Yellow
drawFace(faceZ2, RGB(255, 106, 3)); // Orange
drawFace(faceY2, RGB(235, 175, 1)); // Signal Yellow
drawFace(faceXX1, RGB(1, 156, 220)); // Light Blue
drawFace(faceZ3, RGB(196, 0, 66)); // Red
drawFace(faceXX2, RGB(55, 58, 191)); // Brilliant Blue
drawFace(faceYY1, RGB(85, 2, 156)); // Purple
drawFace(faceZ4, RGB(206, 115, 24)); // Coffee
drawFace(faceYY2, RGB(177, 149, 198), t, 8); // Lilac
drawFace(faceX2, RGB(77, 37, 1), t, 3); // Chocolate
drawFace(faceZZ1, RGB(0, 147, 102), t, 10); // Green
drawFace(faceX3, RGB(255, 255, 255), t); // White
drawFace(faceYY3, RGB(246, 166, 191), t, 1); // Pink
...
drawFace(faceX4, RGB(233, 211, 174), t, 6); // Beige
...
drawVertex4(vertexX, RGB(1, 156, 220), t, 1); // Light Blue
