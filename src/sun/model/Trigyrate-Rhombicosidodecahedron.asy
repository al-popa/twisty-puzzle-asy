...
triple EB = X - p * Y;
triple EC = -Z - p * X;
transform3 j1 = rotate(36, EA);
transform3 j2 = rotate(36, EB);
transform3 j3 = rotate(36, EC);
AA = j1 * AA;
AC = j1 * AC;
BB = j1 * BB;
AI = j1 * AI;
...
face fah = constructFace(AH, DO, confj2);
...
face fao = constructFace(AO, DF, confj2);
face fap = constructFace(AP, DP, confj1);
face faq = constructFace(AQ, DF, conf);
face far = constructFace(AR, DN, conf);
face fas = constructFace(AS, DF, confj1);
face fat = constructFace(AT, DP, confj2);
...
face fbj = constructFace(BJ, DG, confj1);
face fbk = constructFace(BK, DD, confj2);
face fbl = constructFace(BL, DD, conf);
face fbm = constructFace(BM, DD, confj1);
face fbn = constructFace(BN, DR, confj1);
face fbo = constructFace(BO, DC, conf);
face fbp = constructFace(BP, DC, conf);
face fbq = constructFace(BQ, DC, conf);
face fbr = constructFace(BR, DR, confj2);
face fbs = constructFace(BS, DL, confj1);
face fbt = constructFace(BT, DN, conf);
face fca = constructFace(CA, DH, conf);
face fcb = constructFace(CB, DT, confj1);
face fcc = constructFace(CC, DT, conf);
face fcd = constructFace(CD, DH, confj2);
face fce = constructFace(CE, DG, conf);
face fcf = constructFace(CF, DH, confj1);
face fcg = constructFace(CG, DG, confj2);
face fch = constructFace(CH, DS, conf);
face fci = constructFace(CI, DR, conf);
face fcj = constructFace(CJ, DQ, confj2);
face fck = constructFace(CK, DK, confj1);
face fcl = constructFace(CL, DL, confj2);
face fcm = constructFace(CM, DT, confj2);
face fcn = constructFace(CN, DL, conf);
face fco = constructFace(CO, DK, confj2);
face fcp = constructFace(CP, DK, conf);
face fcq = constructFace(CQ, DO, confj1);
...
glueFaces(fao, faq, fas, d);
glueFaces(fac, fba, fbc, d);
glueFaces(fbb, fbd, fbh, d);
glueFaces(fbe, fbf, fbg, d);
glueFaces(fbk, fbl, fbm, d);
glueFaces(fbo, fbp, fbq, d);
glueFaces(far, fbi, fbt, d);
glueFaces(fca, fcd, fcf, d);
glueFaces(fbj, fce, fcg, d);
glueFaces(fbn, fbr, fci, d);
glueFaces(fag, fai, fcj, d);
glueFaces(fcb, fcc, fcm, d);
glueFaces(fbs, fcl, fcn, d);
glueFaces(fck, fco, fcp, d);
glueFaces(fap, fat, fcr, d);
glueFaces(faj, fch, fcs, d);
glueFaces(fah, fcq, fct, d);
glueFaces(fab, fas, d);
glueFaces(fah, fas, d);
glueFaces(fao, fak, d);
glueFaces(fak, fam, d);
...
vertex4 vvioletlightblue = constructVertex4(fbj, fbr, fci, fce);
vertex4 vorangelightblue = constructVertex4(fbl, fci, fbn, fbk);
...
vertex4 vlightbluegreen = constructVertex4(fca, fcf, fcg, fce);
vertex4 vorangegrey = constructVertex4(fbk, fbn, fbp, fbo);
vertex4 vlightbluegrey = constructVertex4(fbl, fbm, fcm, fcc);
...
vertex4 vlightbluelime = constructVertex4(fca, fcc, fcb, fcd);
...
vertex4 vbluepink = constructVertex4(fah, fct, faq, fas);
vertex4 vredpink = constructVertex4(fco, fcp, fct, fcq);
vertex4 vlimepink = constructVertex4(fck, fcl, fcn, fcp);
vertex4 vgreypink = constructVertex4(fat, fcr, fcn, fbs);
vertex4 vlightgreenpink = constructVertex4(fap, fao, faq, fcr);
...
drawFace(fcd, Green + Ametist, t, 4);
...
drawFace(fcc, LightBlue + Brown, t, 1);
drawFace(fce, LightBlue + Ametist);
drawFace(fci, LightBlue + Garnet);
drawFace(fcb, Lime + Platina, t);
drawFace(fcm, Lime + Lilac, t, 11);
drawFace(fck, Lime + Brown);
drawFace(fco, Lime + Ametist);
drawFace(fcs, Lime + Garnet, t, 4);
...
drawVertex4(vlightbluelime, Blue + Yellow, t, 2);
drawVertex4(vgreylime, White + Yellow);
drawVertex4(vredlime, Orange + Yellow);
drawVertex4(vgreenlime, LightGreen + Yellow, t, 0);
