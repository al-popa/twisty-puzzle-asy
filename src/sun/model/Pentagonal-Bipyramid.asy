...
bool[] confTrapez = new bool[] {true, true, false, true, true, false, true, true, false, true};
...
real d = glueFaces(face1, face2);
glueFaces(face2, face3, d);
glueFaces(face3, face4, d);
glueFaces(face4, face5, d);
glueFaces(face5, face1, d);
glueFaces(face11, face22, d);
glueFaces(face22, face33, d);
glueFaces(face33, face44, d);
glueFaces(face44, face55, d);
glueFaces(face55, face11, d);
...
vertex5 vertexZ = constructVertex5(face1, face2, face3, face4, face5);
vertex5 vertexZZ = constructVertex5(face55, face44, face33, face22, face11);
...
drawVertex5(vertexZ, Tan);
drawVertex5(vertexZZ, Tan, t, 2);
